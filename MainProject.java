...
public class MainProject implements MouseListener{

    public JFrame frame;
    public JPanel canvasPanel;
    public JPanel controlPanel;
    public ArrayList<JPanel> rooms = new ArrayList<JPanel>();
    public ArrayList<JPanel> doors = new ArrayList<JPanel>();
    public ArrayList<JLabel> wins = new ArrayList<JLabel>();
    ...
    public MainProject() {
        ...
        // Color color = JColorChooser.showDialog(frame, "Color Chooser", Color.lightGray);
        ...
        newRoom.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == newRoom) {
                    ...
                    JTextField text2 = new JTextField("200");
                    ...
                    for (int q = 0; q < components.length; q++) {
                        ...
                        components[q].addMouseMotionListener(new MouseAdapter() {
                            ...
                            public void mouseDragged(MouseEvent e) {
                                ...
                                if(components[r] instanceof JLabel)
                                {
                                    ...
                                    if((components[r]).getWidth() == 30 && (components[r]).getHeight() == 2)
                                    {
                                        yMoved = 0;
                                    }
                                    else if((components[r]).getWidth() == 2 && (components[r]).getHeight() == 30)
                                    {
                                        xMoved = 0;
                                    }
                                    ...
                                    if (new01.x < 0 || new01.y < 0 || new10.x > rooms.get(j).getWidth() || rooms.get(j).getHeight() < new10.y);
                                    else {
                                ...
                                else
                                {
                                    ...
                                    if((components[r]).getWidth() == 30)
                                    {
                                        yMoved = 0;
                                    }
                                    else if((components[r]).getHeight() == 30)
                                    {
                                        xMoved = 0;
                                    }
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (SwingUtilities.isRightMouseButton(e)) {
            if (rooms.contains(e.getSource())) {
                ...
                IconMenuItem Kitsink = new IconMenuItem(rightPanel,Kitsinks,"Kitchen Sink");
                Fixture.add(Kitsink);
                String[] Showers = {"Shower1.png","Shower2.png", "Shower1.png","Shower2.png"};
                ...
                IconMenuItem Wash = new IconMenuItem(rightPanel,Washbasins,"Wash Basin");
                Fixture.add(Wash);
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (!BoundaryCheck((JPanel) e.getSource())) {
            JOptionPane.showMessageDialog(frame, "Room can't be placed", "Room Out Of Bound", JOptionPane.ERROR_MESSAGE);
            ((JPanel) e.getSource()).setLocation(PrevCoord);
        }
    }
